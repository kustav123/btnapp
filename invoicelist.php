      ...
      <div class="card">
          ...
          <table class="table datatable">
            <thead>
              <tr>
                ...
                <th scope="col">Caustomer Mobile</th>
        ...
        <?php
             if($result = mysqli_query($link, $sql)){
                ...
                echo "<td>" . $row['date'] . "</td>";
                echo "<td>" . $row['castmob'] . "</td>";
                echo "<td>" . $row['total'] . "</td>";
           
      

                echo "<td>";
                    echo '<a href="listbill.php?mob='. $row['castmob'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fas fa-file-invoice fa-spin" style="color: #0a4cbd;"></span></a>';
